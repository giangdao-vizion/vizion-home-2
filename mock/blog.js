...
export const blogListMock = [
  {
    id: 1,
    categoryId: categoryIdMock.DIGITAL_MARKETING,
    category: 'Digital Marketing',
    createdAt: Date.now().toString(),
    createdBy: 'Thu Pham',
    imageUrl: '/assets/images/vizion/blogs/9-5-bai-chuyen-doi-so.jpg',
    linkBlogUrl: `/bai-viet/${categoryIdMock.DIGITAL_MARKETING}/1`,
    linkCategoryUrl: `/${categoryIdMock.DIGITAL_MARKETING}`,
    tag: '',
  ...
  },
  {
    ...
    linkBlogUrl: `/bai-viet/${categoryIdMock.DIGITAL_MARKETING}/2`,
    linkCategoryUrl: `/${categoryIdMock.DIGITAL_MARKETING}`,
    tag: '',
  ...
  },
  {
    ...
    linkBlogUrl: `/bai-viet/${categoryIdMock.DIGITAL_MARKETING}/3`,
    linkCategoryUrl: `/${categoryIdMock.DIGITAL_MARKETING}`,
    tag: '',
  ...
  },
  {
    ...
    linkBlogUrl: `/bai-viet/${categoryIdMock.DIGITAL_MARKETING}/4`,
    linkCategoryUrl: `/${categoryIdMock.DIGITAL_MARKETING}`,
    tag: '',
  ...
  },
  {
    id: 5,
    category: 'Stories',
    categoryId: categoryIdMock.STORIES,
    createdAt: Date.now().toString(),
    createdBy: 'Thu Pham',
    imageUrl: '/assets/images/vizion/blogs/Screenshot-104-1.png',
    linkBlogUrl: `/bai-viet/${categoryIdMock.STORIES}/5`,
    linkCategoryUrl: `/${categoryIdMock.STORIES}`,
    tag: '',
  ...
  },
  {
    ...
    linkBlogUrl: `/bai-viet/${categoryIdMock.STORIES}/6`,
    linkCategoryUrl: `/${categoryIdMock.STORIES}`,
    tag: '',
  ...
  },
  {
    ...
    linkBlogUrl: `/bai-viet/${categoryIdMock.STORIES}/7`,
    linkCategoryUrl: `/${categoryIdMock.STORIES}`,
    tag: '',
