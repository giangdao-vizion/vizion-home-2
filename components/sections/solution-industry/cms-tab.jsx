...
export default function CMC_Tab() {
  return (
    <>
      <section
        className="section background-half-right spdtb overflow-hidden"
        style={{ backgroundImage: 'url(/assets/images/wave-02.png)' }}
      >
          ...
          <div className="row row-full flex-align-c">
            ...
            <div className="col-lg-7 d-none d-lg-block col-full-right">
              <img
                ...
                src="/assets/images/vizion/solution/industry4.png"
                alt="Banner"
              />
            </div>
          </div>
