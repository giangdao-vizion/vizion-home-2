        ...
        <div className="container">
          <div className="section spdt mb60">
            <div className="container">
              <div className="heading align-center">
                ...
                <h2 className="heading-title size-l">Platform Features</h2>
              </div>
            </div>
          </div>
          <div className="block-tab tab-wrap layout-02">
            <div className="row flex-align-c">
                ...
                <div className="images layout-12 pt30 pb30">
                  <div className="inner">
                    <div id="custom-course" className={activeIndex === 1 ? 'tab-content is-active' : 'tab-content'}>
                      <img className="vizion-img03" src="/assets/images/vizion-fast.png" alt="Image" />
                    </div>
                    <div id="settings" className={activeIndex === 2 ? 'tab-content is-active' : 'tab-content'}>
                      <img className="vizion-img03" src="/assets/images/vizion-easy.png" alt="Image" />
                    </div>
                    <div id="helps" className={activeIndex === 3 ? 'tab-content is-active' : 'tab-content'}>
                      <img className="vizion-img03" src="/assets/images/vizion-smart.png" alt="Image" />
                    </div>
                  </div>
                </div>
              </div>
              <div className={`col-xl-5 col-lg-12 ${activeIndex === 1 ? 'vz-is-active' : 'vz-discover'}`}>
                <div className="heading align-left mb24">
                  ...
                  <div className="heading-desc">
                    Tôi ưu hóa hiệu suất của tour để có thể hoạt động mượt mà trên nhiều thiết bị thông minh, đảm bảo
                    tính khả dụng và tiện lợi cho khách hàng của bạn.
                  </div>
                </div>
              </div>

              <div className={`col-xl-5 col-lg-12 ${activeIndex === 2 ? 'vz-is-active' : 'vz-discover'}`}>
                <div className="heading align-left mb24">
                  <h2 className="heading-title size-l">
              ...
              <div className={`col-xl-5 col-lg-12 ${activeIndex === 3 ? 'vz-is-active' : 'vz-discover'}`}>
                <div className="heading align-left mb24">
                  <h2 className="heading-title size-l">
