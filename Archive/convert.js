...
// Thay đổi hàm main thành một hàm có thể export được
async function processImage(inputBuffer) {
  ...
  for (const face of sides) {
    ...
    results[face] = resultCanvas.toBuffer('image/png');
  }
...
// Xóa hoặc comment out hàm main() và phần gọi main().catch(console.error);
